...
export default function AboutPage() {
  return (
    <article className="mx-auto w-full max-w-3xl px-5 py-16">
      ...
      <h1 className="mt-3 text-4xl font-bold tracking-tight">The person enterprises call when AI meets people</h1>
      <p className="mt-5 text-lg leading-8 text-ink-muted">
        Coaching is the method. AI is the territory. Real Talk Studio is the proof. I help enterprises with the
        human side of AI — change management, coaching, and the conversations nobody scheduled. Here is the
