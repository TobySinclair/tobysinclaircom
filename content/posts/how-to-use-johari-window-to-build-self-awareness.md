...
![Johari Window Banner](https://static.wixstatic.com/media/67d4e8_0d27660a39244898858c56299b69d57b~mv2.png)
...
It was devised by American psychologists Joseph Luft and Harry Ingham in 1955 while researching group dynamics at the University of California Los Angeles. The model was first published in the Proceedings of the Western Training Laboratory in Group Development by the UCLA Extension Office in 1955 and was later expanded by Joseph Luft. The model name is derived from combining the two names Joseph and Harry.
...
[This HBR Article](https://hbr.org/2018/01/what-self-awareness-really-is-and-how-to-cultivate-it) explores what self-awareness is and how it can help you be a better leader.

In particular, the article defines two types, Internal and External Self-awareness:

![Self Awareness and Johari Window](https://static.wixstatic.com/media/67d4e8_92719b9509794593aa6e54ea1cd893dd~mv2.png)
...
A good outcome is a perfect alignment between how you see yourself and what others see you. This happens when you are a very open leader who has worked with a stable group for some time.

A common outcome is a difference between how you see yourself and how others see you. There are values important to you that others are unaware of. There are also values you demonstrate that other people see but you are not aware of.

The Johari window helps create this awareness of these contrasts. With this knowledge, you can work to increase your open area. Where how you see yourself aligns with how others perceive you. This is done by discussing the results with the group and seeking greater understanding.

[![](https://static.wixstatic.com/media/67d4e8_deec9f84ec274ae1b7e589de4dbdff32~mv2.png)](https://blinkist.o6eiov.net/0ZWj53)

### **How does the Johari Window Model work?**

To gather perspectives you will use a list of [Johari window adjectives](#viewer-diff9). These are used to surface insights for discussion.
...
3. Categorise the results into the four [Johari Window Quadrants](#viewer-8ur88).
...
[This Miro Board](https://miro.com/templates/johari-window/) is a great way to facilitate the Johari Window exercise.

### **What are the four quadrants of the Johari Window?**

The Johari Window quadrants are as follows:

![Johari Window Quadrants](https://static.wixstatic.com/media/67d4e8_c1a48d18f9934a98b2265d311c682c59~mv2.jpg)
...
The Johari Window is a great exercise to use with new teams. It helps build awareness of each other's values and strengths. It can be used as a baseline to see improvement in the team's understanding of each other.
...
**Example: Use AI avatars to practice coaching a team members blindspot**
...
You can dig deeper by asking more about what you can do to demonstrate this trait.

[![](https://static.wixstatic.com/media/67d4e8_28a3b78acf894905ab300f2d3dc588e6~mv2.jpeg)](https://blinkist.o6eiov.net/0ZWj53)
...
Through discussion, this was in response to how the leader was handling deadlines. In times of pressure, the team were observing the leader making bold decisions. This led to frustration in the team and constantly changing priorities. The team would welcome a calm and organized response.
...
[![Johari Window Template](https://static.wixstatic.com/media/67d4e8_c2821f19a9b441369238673ef201b2c4~mv2.png)](https://miro.com/templates/johari-window/)
